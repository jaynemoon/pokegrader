          ...
          <div className="bg-slate-50 rounded-3xl p-8 border-2 border-slate-200">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-700">5 free card grades per month</span>
              </li>
              <li className="flex items-center gap-3">
                <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0" />
            ...
            <button className="w-full bg-slate-200 hover:bg-slate-300 text-slate-700 px-6 py-3 rounded-2xl font-semibold transition-all duration-200">
              Current Plan
            </button>
          </div>

          {/* Pro Plan */}
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 border-2 border-blue-200 relative">
