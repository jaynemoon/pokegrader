          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div className="col-span-1 sm:col-span-2 lg:col-span-2">
              ...
              <div className="flex items-center space-x-6 mb-8">
                <a href="https://x.com/login" className="text-slate-500 hover:text-slate-700 dark:text-cyan-100 dark:hover:text-white transition-colors">
                  <span className="sr-only">X</span>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://discord.com/login" className="text-slate-500 hover:text-slate-700 dark:text-cyan-100 dark:hover:text-white transition-colors">
                ...
                <a href="https://www.reddit.com/login" className="text-slate-500 hover:text-slate-700 dark:text-cyan-100 dark:hover:text-white transition-colors">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <button
                    ...
                    className="text-slate-600 hover:text-slate-800 dark:text-cyan-100 dark:hover:text-white transition-colors cursor-pointer"
                  >
                    Features
                  </button>
                </li>
