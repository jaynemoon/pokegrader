        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div className="col-span-1 sm:col-span-2 lg:col-span-2">
              ...
              <p className="text-cyan-100 hover:text-cyan-300 text-sm mb-6 max-w-xs sm:max-w-md">
                Professional AI-powered Pokemon card grading with instant results. Get PSA grades for trade price in seconds.
              </p>

              {/* Social media icons */}
              <div className="flex items-center space-x-6 mb-8">
                <a href="https://x.com/login" className="text-cyan-100 hover:text-cyan-300  transition-colors">
                  <span className="sr-only">X</span>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M6.29 18.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0020 3.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.073 4.073 0 01.8 7.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 010 16.407a11.616 11.616 0 006.29 1.84" />
                  </svg>
                </a>
                <a href="https://discord.com/login" className="text-cyan-100 hover:text-cyan-300 transition-colors">
                ...
                <a href="https://www.reddit.com/login" className="text-cyan-100 hover:text-cyan-300 transition-colors">
            ...
            <div className="mt-8 sm:mt-0">
              <h3 className="text-cyan-100 hover:text-cyan-300 font-semibold mb-4">Product</h3>
            ...
            {/* Company column */}
            <div className="mt-8 sm:mt-0">
              <h3 className="text-cyan-100 hover:text-cyan-300 font-semibold mb-4">Company</h3>
              <ul className="space-y-3 text-sm">
                <li>
                  <button
                    onClick={() => setCurrentView('support')}
                    className="text-cyan-100 hover:text-cyan-300 transition-colors duration-200"
                  >
                    Support
                  </button>
                </li>
